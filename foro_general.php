...
$foro_id = 'general'; // Cambia esto para cada foro (general, tecnico, sugerencias, proyectos)
$foro_nombre = 'Foro General'; // Cambia el nombre para cada foro
$foro_descripcion = 'Discusión general sobre cualquier tema relacionado con el proyecto'; // Cambia la descripción
