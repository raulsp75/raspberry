...
$foro_id = 'sugerencias'; // Cambia esto para cada foro (general, tecnico, sugerencias, proyectos)
$foro_nombre = 'Sugerencias'; // Cambia el nombre para cada foro
$foro_descripcion = 'Propuestas de mejora y nuevas ideas para el proyecto'; // Cambia la descripción
